...
public class AppointmentSessionManager {
    private  static  final String KEY_APPOINTMENTID = "id";
    ...
    public void createAppointmentSession(Appointment appointment) {
        editor.putString(KEY_APPOINTMENTID, appointment.getId());
    ...
    public Appointment getAppointmentDetails() {
        String id = sharedPreferences.getString(KEY_APPOINTMENTID,"");
        ...
        return new Appointment(id,date, doctor, note, status, service, userIdStatus, temperature, bloodPressure, medicalHistory, diagnostic);
    }
