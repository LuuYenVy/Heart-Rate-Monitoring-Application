...
public class Appointment {
    ...
    public Appointment(String id, String service, String date, String status) {
        this.id = id;
        this.service = service;
        this.date = date;
        this.status = status;
    }
    public Appointment(String id, String date, String doctor, String note, String status, String service,String userid_status,String temperature, String blood_pressure,String medical_history, String diagnostic)
    {
        this.id=id;
        this.date = date;
        this.doctor = doctor;
